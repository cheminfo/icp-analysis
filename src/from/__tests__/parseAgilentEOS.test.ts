    ...
    elements: [
      {
        ...
        quantity: { units: 'mg/l', value: 0.12 },
      },
      {
        element: 'Al',
        wavelength: { value: 309.271, units: 'nm' },
        quantity: { units: 'mg/l', value: 0.1 },
      },
      {
        element: 'Al',
      ...
      },
      {
        ...
        quantity: { units: 'mg/l', value: 2.67 },
      },
      {
        element: 'Cu',
        wavelength: { value: 324.754, units: 'nm' },
        quantity: { units: 'mg/l', value: 2.66 },
      },
      {
        element: 'Cu',
        wavelength: { value: 327.395, units: 'nm' },
        quantity: { units: 'mg/l', value: 2.65 },
      },
    ],
